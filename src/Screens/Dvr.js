...
const Dvr = ({ navigation }) => {
    ...
    async function getDVR() {
        try {
            let response = await fetch('http://192.168.1.100:8000/api/dvr-details');
    ...
    const UpdateDvr = async () => {
        ...
        fetch('http://192.168.1.100:8000/api/update-dvr-details', requestOptions)
    ...
    const DeleteDvr = async () => {
        ...
        console.log(raw);
        fetch("http://192.168.1.100:8000/api/delete-dvr-details", requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
