...
const DvrDetails = ({ navigation, route }) => {
    ...
    async function getCamera() {
        try {
            let response = await fetch('http://192.168.1.100:8000/api/camera-details/' + id);
    ...
    async function GetVenue() {
        ...
        let response = await fetch('http://192.168.1.100:8000/api/venue-details')
    ...
    const UpdateCamera = async () => {
        ...
        console.log(raw);
        fetch('http://192.168.1.100:8000/api/update-camera-details', requestOptions)
    ...
    const DeleteCamera = async () => {
        ...
        console.log(raw);
        fetch("http://192.168.1.100:8000/api/delete-camera-details", requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
    ...
    const AddCamera = async () => {
        ...
        fetch("http://192.168.1.100:8000/api/add-camera", requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
