...
const AddUser = ({ navigation }) => {
    ...
    const handleSavePress = async () => {
        ...
        fetch("http://192.168.1.103:8000/api/add-user?id=" + 0 + "&userID=" + id + "&name=" + name + "&password=" + password + "&role=" + selectedUser, requestOptions)
    ...
    const StdSavePress = async () => {
        ...
        fetch("http://192.168.1.103:8000/api/add-student?aridNo=" + id + "&name=" + name + "&image=" + 0 + "&password=" + password, requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
